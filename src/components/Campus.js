...
function Campus() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const itemsResponse = await fetch(`https://lostandfoundback-184f1a940482.herokuapp.com/api/items/location/${campusName}`);
        ...
        const countsResponse = await fetch(`https://lostandfoundback-184f1a940482.herokuapp.com/api/items/location/${campusName}/count-by-category`);
