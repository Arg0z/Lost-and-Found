...
function Campus() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const itemsResponse = await fetch(`https://cors-everywhere.herokuapp.com/http://lostandfoundback-dev.eba-ihrrezy2.us-east-1.elasticbeanstalk.com/api/items/location/${campusName}`);
        ...
        const countsResponse = await fetch(`https://cors-everywhere.herokuapp.com/http://lostandfoundback-dev.eba-ihrrezy2.us-east-1.elasticbeanstalk.com/api/items/location/${campusName}/count-by-category`);
