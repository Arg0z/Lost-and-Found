...
namespace LostAndFoundBack.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Check if the Items table already exists before creating it
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    CREATE TABLE [Items] (
                        ...
                        [date_found] datetime2 NOT NULL,
                        [location_found] nvarchar(max) NOT NULL,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Drop the Items table only if it was created by this migration
            migrationBuilder.Sql(@"
